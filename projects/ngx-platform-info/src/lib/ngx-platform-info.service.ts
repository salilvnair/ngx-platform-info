...
export class NgxPlatformInfo {
  platFormInfo: PlatFormInfo;
  constructor() {
    this._extractPlatformInfo();
  }

  private _extractPlatformInfo() {
    var unknown = '-';
  ...
  for (var id in manufacturerString) {
    ...
    this.platFormInfo.os = os;
    this.platFormInfo.mobile = mobile;
    this.platFormInfo.product = product;
    this.platFormInfo.version = osVersion;
    this.platFormInfo.browser = browser;
    this.platFormInfo.browserVersion = version;
  ...
  public get product() : string {
    return this.platFormInfo.product;
  }
  ...
  public get browserVersion() : string {
    return this.platFormInfo.browserVersion;
  }

  public get browserMajorVersion() : number {
    return this.platFormInfo.browserMajorVersion;
  }
